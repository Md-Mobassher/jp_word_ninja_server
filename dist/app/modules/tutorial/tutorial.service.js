...
const createTutorial = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const newTutorial = yield tutorial_model_1.Tutorial.create(payload);
    if (!newTutorial) {
...
const getAllTutorial = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const TutorialQuery = new QueryBuilder_1.default(tutorial_model_1.Tutorial.find(), query)
        .search(tutorial_constant_1.TutorialSearchableFields)
        .filter()
        .sort()
        .paginate()
        .fields();
...
const getSingleTutorial = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield tutorial_model_1.Tutorial.findById(id);
    return result;
});
const updateTutorial = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield tutorial_model_1.Tutorial.findByIdAndUpdate(id, payload, {
        new: true,
        runValidators: true,
    });
    return result;
...
const deleteTutorial = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const isVideoExist = yield tutorial_model_1.Tutorial.findById(id);
    if (!isVideoExist) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'No Tutorial found');
    }
    yield tutorial_model_1.Tutorial.findByIdAndDelete(id);
    return null;
});
